    ...
    <div class="col-md-8">
        <div class="col-sm-12">
            <div class="well">
                <h4 style="margin: 0px; font-size: 17px">
                    ...
                    {{--<span class="btn btn-xs btn-primary" onclick="javascript:jivo_api.open();"><strong>сюда</strong></span> или--}} сюда
        ...
        <div class="col-lg-4">
            <div class="well">
                ...
                <p>Покупая поднятия, у Вас есть возжоность поднимать свои объявления в общем рейтинге. Стоимость 1 поднятие = 10 <i class="fa fa-ruble"></i></p>
                <hr>
