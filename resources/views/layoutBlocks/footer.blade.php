    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-6 footer-widget widget">
                ...
                <style>div {text-align: left;} span.yandex_date {font-size: 85%; margin-right:0.5em;text-align: left;} div.yandex_informer	{font-size: 85%; margin-bottom: 0.3em;} div.yandex_title 	{font-size: 100%; margin-bottom: 0.5em; }	div.yandex_title a	{ }	div.yandex_allnews	{font-size: 80%; margin-top: 0.3em;} div.yandex_allnews	{font-size: 80%; margin-top: 0.3em;}	div.yandex_annotation		{font-size: 85%; margin-bottom: 0.5em;}</style><script src='https://news.yandex.ru/common.js'></script><script>m_index=false;</script><script src='https://news.yandex.ru/ru/computers3.utf8.js' type='text/javascript' charset='utf-8'></script><script> str='<div class=yandex_title><a href=https://news.yandex.ru><b>Яндекс.Новости</b></a></div>'; if ((aObj=eval('m_computers')) && (aObj.length>0)){for (j=0;j<aObj.length;j++) {
                        str+='<div><span class=yandex_date>'+aObj[j].time+'</span> <span class=yandex_news_title><a href='+aObj[j].url+'>'+aObj[j].title+'</a></span></div>';} str+='<div class=yandex_allnews><a href=https://news.yandex.ru>Все новости на ' + ya_format_date(update_time_t) + ' >></a></div>';  document.write(str);}; function ya_format_date(timestamp){var d = (new Date(timestamp*1000)).toLocaleTimeString().split(':'); return [d[0], d[1]].join(':').replace(/d{1,2}:d{1,2}(:d{1,2})/, '');}</script>
            </div>
            <div class="col-md-3 col-sm-6 footer-widget widget">
